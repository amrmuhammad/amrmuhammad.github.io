...
function gh_ops_copy_menu_item_click_handler(event) {
  ...
  html_code += 'Github destination username : <input id="dest_username" value="amrmuhammad" autocomplete="on"> <br />'
  html_code += 'Github destination repo. name : <input id="dest_repo_name" value="amrmuhammad.github.io" autocomplete="on"> <br />'
  html_code += 'Github destination API personal access token : <input id="dest_gh_pat" autocomplete="on"> <br />'
  html_code += 'Path within dest repo : <input id="path_within_dest_repo" autocomplete="on"> <br />'
  html_code += 'Github source username : <input id="source_username" autocomplete="on" > <br />'
  html_code += 'Github source repo. name : <input id="source_repo_name" autocomplete="on" > <br />'
  html_code += 'Path within source repo : <input id="path_within_source_repo" autocomplete="on" > <br />'
