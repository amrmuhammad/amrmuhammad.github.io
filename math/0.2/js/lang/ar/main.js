...
html_code += construct_matrix("matrix1", "المصفوفة الأولي:")
html_code += '<br />'
html_code += construct_matrix("matrix2", "المصفوفة الثانية:")
html_code += '<br /> <br  />'
html_code += '<button id="multiply_matrices_button">ضرب المصفوفات</button>'  
html_code += '<br /> <br />'
...
html_code += '<br /> <br />'
html_code += 'Content is available under <a href="https://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA 3.0</a>'
///////////////////////////////////
